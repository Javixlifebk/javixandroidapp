...
import static com.sumago.latestjavix.AllSurveyActivity.imgV3;
...
import com.sumago.latestjavix.SocioEconomic;
...
public class SocioEconomicSurveyFragment extends Fragment {
    ...
    public SocioEconomicSurveyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_socio_economic_survey, container, false);
        ...
        noOfEarners=(EditText)view.findViewById(R.id.noOfEarners);
        nameOfEarners=(EditText)view.findViewById(R.id.nameOfEarners);
        ageOfEarners=(EditText)view.findViewById(R.id.ageOfEarners);
        occupationOfEarners=(Spinner)view.findViewById(R.id.occupationOfEarners);
        isBankAccount=(Spinner)view.findViewById(R.id.isBankAccount);
        statusOfHouse=(Spinner)view.findViewById(R.id.statusOfHouse);
        totalIncome=(Spinner)view.findViewById(R.id.totalIncome);
        foodExpense=(Spinner)view.findViewById(R.id.foodExpense);
        healthExpense=(Spinner)view.findViewById(R.id.healthExpense);
        educationExpense=(Spinner)view.findViewById(R.id.educationExpense);
        intoxicationExpense=(Spinner)view.findViewById(R.id.intoxicationExpense);
        conveyanceExpense=(Spinner)view.findViewById(R.id.conveyanceExpense);
        cultivableLand=(Spinner)view.findViewById(R.id.cultivableLand);
        ...
        if (Shared_Preferences.getPrefs(getActivity(), "GS_Done").equals("1") && Shared_Preferences.getPrefs(getActivity(), "HS_Done").equals("1")){
    ...
    void submitForm(View v){
       ...
       // ErrBox.errorsStatus();  // need to solve this problem
        ...
        if(Config.isOffline){
            try {
                ...
                alertDialog.setMessage(getActivity().getString(R.string._socioeconomicSurveyAdd_he));
                alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
            ...
            SocioEconomicSurveyFragment.SubmitForm req=new SocioEconomicSurveyFragment.SubmitForm(getActivity(),paramHash);
...
//                            Intent i = new Intent(getActivity(), SurveyMenuActivity.class);
                            ...
                            Shared_Preferences.setPrefs(getActivity(), "GS_Done", "");
                            Shared_Preferences.setPrefs(getActivity(), "HS_Done", "");
