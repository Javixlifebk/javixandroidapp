...
public class AddSickleCell extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_sickle_cell);
        initViews();
    }
    ...
    public void initViews(){
        ...
        ArrayAdapter<CharSequence> adp2= ArrayAdapter.createFromResource(this, R.array.strType, android.R.layout.simple_spinner_item);
...
;
        ...
        cmdSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(getApplicationContext(), strType, Toast.LENGTH_LONG).show();
    ...
    void submitForm(View v){
        ...
        //Toast.makeText(MyConfig.CONTEXT,Integer.toString(_varCell),Toast.LENGTH_SHORT).show();
        paramHash.put("SickleCell", Integer.toString(_varCell));
        ...
        //Toast.makeText(getApplicationContext(),Config.tmp_caseId,Toast.LENGTH_LONG).show();
        if(Config.isOffline){
            try {
                SQLiteDatabase db;
                ...
                SqlStr += " VALUES('Add Sickle Cell','" + MyConfig.URL_ADDSICKLECELL + "','" + paramHash.toString() + "','"+jsonObject.toString()+"','" + currentDate + "',0);";
                //Toast.makeText(getApplicationContext(), SqlStr, Toast.LENGTH_LONG).show();
                Log.e("Offline", SqlStr);
                db.execSQL(SqlStr);
                db.close();
                android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(AddSickleCell.this
                );
                alertDialog.setMessage("Sickle Cell Test Done Successfully !" );
                alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Intent i = new Intent(AddSickleCell.this, LabTestActivity.class);
                        //Config.tmp_caseId="0";
                        finish();
                        startActivity(i);
                    }
            ...
            req.execute(MyConfig.URL_ADDSICKLECELL);
        }
