...
public class HealthSurvey extends AppCompatActivity {
   ...
   String[] strNonUsageOfToilets_Hn ={"शौचालय","शौचालय नहीं","गलत तरीके से बनाया गया","पानी की कमी","अन्य","मैं शौचालय का उपयोग कर रहा हूँ"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoOfPersonUsingToilets=(EditText)findViewById(R.id.NoOfPersonUsingToilets);
        drinkingWaterSource=(Spinner)findViewById(R.id.drinkingWaterSource);
        drinkingWaterDistance=(Spinner)findViewById(R.id.drinkingWaterDistance);
        isdrinkingWaterTreatmentRequired=(Spinner)findViewById(R.id.isdrinkingWaterTreatmentRequired);
        NonUsageOfToilets=(Spinner)findViewById(R.id.NonUsageOfToilets);
        DistanceOfSubcenters=(Spinner)findViewById(R.id.DistanceOfSubcenters);
        DistanceOfPrimaryHealthcenters=(Spinner)findViewById(R.id.DistanceOfPrimaryHealthcenters);
        DistanceOfCommunityHealthcenters=(Spinner)findViewById(R.id.DistanceOfCommunityHealthcenters);
        DistanceOfDistrictHospitals=(Spinner)findViewById(R.id.DistanceOfDistrictHospitals);
        DistanceOfPathologyLab=(Spinner)findViewById(R.id.DistanceOfPathologyLab);
        DistanceOfMedicalStore=(Spinner)findViewById(R.id.DistanceOfMedicalStore);
        StatusOfDeliveryOfChildren=(Spinner)findViewById(R.id.StatusOfDeliveryOfChildren);
        StatusOfVaccinationOfChildren=(Spinner)findViewById(R.id.StatusOfVaccinationOfChildren);
        StatusOfFemaleRelatedProblem=(Spinner)findViewById(R.id.StatusOfFemaleRelatedProblem);
        CentrallyIssuedHealthInsurance=(Spinner)findViewById(R.id.CentrallyIssuedHealthInsurance);
        StateIssuedHealthInsurance=(Spinner)findViewById(R.id.StateIssuedHealthInsurance);
        PersonalHealthInsurance=(Spinner)findViewById(R.id.PersonalHealthInsurance);
        ...
        ArrayAdapter adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strdrinkingWaterSource);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        drinkingWaterSource.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strdrinkingWaterDistance);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        drinkingWaterDistance.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strisdrinkingWaterTreatmentRequired);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        isdrinkingWaterTreatmentRequired.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strNonUsageOfToilets);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        NonUsageOfToilets.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strDistanceOfSubcenters);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        DistanceOfSubcenters.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strDistanceOfPrimaryHealthcenters);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        DistanceOfPrimaryHealthcenters.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strDistanceOfCommunityHealthcenters);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        DistanceOfCommunityHealthcenters.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strDistanceOfDistrictHospitals);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        DistanceOfDistrictHospitals.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strDistanceOfPathologyLab);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        DistanceOfPathologyLab.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strDistanceOfMedicalStore);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        DistanceOfMedicalStore.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strStatusOfDeliveryOfChildren);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        StatusOfDeliveryOfChildren.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strStatusOfVaccinationOfChildren);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        StatusOfVaccinationOfChildren.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strStatusOfFemaleRelatedProblem);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        StatusOfFemaleRelatedProblem.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strCentrallyIssuedHealthInsurance);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        CentrallyIssuedHealthInsurance.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strStateIssuedHealthInsurance);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        StateIssuedHealthInsurance.setAdapter(adp1);

        adp1 = new ArrayAdapter(this,android.R.layout.simple_spinner_item,strPersonalHealthInsurance);
        adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    void submitForm(View v){
        ...
        if(Config.isOffline){
            try {
                ...
                db.execSQL(SqlStr);
                db.close();
                android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(HealthSurvey.this
                );
                alertDialog.setMessage(HealthSurvey.this.getString(R.string._healthSurveyAdd_he));
                alertDialog.setPositiveButton(HealthSurvey.this.getString(R.string._ok_he), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Intent i = new Intent(HealthSurvey.this, SurveyMenuActivity.class);
                        Config.tmp_caseId="0";
                        finish();
                        startActivity(i);
                    }
    ...
    public void getFamilyID(){
        ...
        getDataList req=new getDataList(this,paramHash);
    ...
    class getDataList extends AsyncTask<String, Void, String> {
        ...
        public getDataList(Activity activity,HashMap<String, String> paramsHash) {
            ...
            this.paramsHash=paramsHash;
            progressDialog = new ProgressDialog(activity);
            progressDialog.setMessage(HealthSurvey.this.getString(R.string._loading_he));
        }
        @Override
        protected void onPreExecute(){
            progressDialog.show();
