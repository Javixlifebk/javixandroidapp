...
public class AddDoctorProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstName=(EditText)findViewById(R.id.addDoctorProfile_fisrtName);
        lastName=(EditText)findViewById(R.id.addDoctorProfile_lastName);
        gender=(Spinner)findViewById(R.id.addDoctorProfile_gender);
        mobileNo=(EditText)findViewById(R.id.addDoctorProfile_mobileNo);
        email=(EditText)findViewById(R.id.addDoctorProfile_email);
        dob=(EditText)findViewById(R.id.addDoctorProfile_dbo);
        qualification=(Spinner) findViewById(R.id.addDoctorProfile_qualification);
        specialization=(EditText)findViewById(R.id.addDoctorProfile_sepcialiazation);
        country=(EditText)findViewById(R.id.addDoctorProfile_country);
        state=(Spinner) findViewById(R.id.addDoctorProfile_state);
        district=(EditText)findViewById(R.id.addDoctorProfile_district);
        address=(EditText)findViewById(R.id.addDoctorProfile_address);
        // Date Picker
        ...
        dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(AddDoctorProfile.this, dateListener, myCalendar
    ...
    void submitForm(View v)
    {
        ...
        AddDoctorProfile.SubmitForm req=new AddDoctorProfile.SubmitForm(this,paramHash);
